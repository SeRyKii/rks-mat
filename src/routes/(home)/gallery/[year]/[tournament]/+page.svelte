...
<div class="w-full flex flex-col items-center">
  <div class="w-full py-0 sm:px-16 md:px-32 lg:px-64 flex flex-col">
    <div
      class="h-8 sm:h-12 rounded-t-2xl bg-surface-100-800-token text-token font-bold text-md sm:text-2xl flex items-center justify-center shadow-lg dark:shadow-surface-500"
    >
    ...
    <div class="w-full flex flex-row h-8 sm:h-12">
      ...
      >
      <div
        class="w-full bg-surface-100-800-token shadow-lg dark:shadow-surface-500 whitespace-nowrap overflow-x-scroll overflow-y-hidden inline-block"
      >
      ...
      <div class="w-auto bg-surface-100-800-token" />
      <button
        on:click={goRight}
